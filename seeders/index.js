...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'hoVjaMvcNMFGsBZ',
      'isDeleted':false,
      'username':'Justina6',
      'email':'Telly.Wiegand@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Justina6' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'qCPS9jFKMwLrSrI',
      'isDeleted':false,
      'username':'Ignacio77',
      'email':'Maureen93@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Ignacio77' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
